...
/**
 * This interface is used to define the methods that will be used to interact with the Customer table in the database.
 * The methods defined in this interface will be used by the CustomerService class to perform various operations on the Customer table.
 * @see CustomerService
 */
@Repository
